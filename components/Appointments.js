...
const Appointments = () => {
    ...
    const handleAddAppointment = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3000/appointments/add', newAppointment)
            .then(response => {
                console.log("Added appointment:", response.data);
    ...
    const handleUpdateAppointment = (id, e) => {
        e.preventDefault();
        axios.post(`http://localhost:3000/appointments/update/${id}`, selectedAppointment)
            .then(response => {
    ...
    const handleDeleteAppointment = (id) => {
        axios.delete(`http://localhost:3000/appointments/delete/${id}`)
            .then(response => {
